  ...
  return (
    <div className="max-w-5xl mx-auto py-12 animate-fade-in font-sans">
      <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 font-black text-xs uppercase tracking-widest rounded-lg mb-4">
        ...
        {badges.map((badge, index) => (
          ...
          >
            <div className="flex items-start justify-between mb-8">
              ...
              {badge.earned && (
                <span className="text-xs font-black text-emerald-500 uppercase tracking-widest">Validated</span>
              )}
            </div>
